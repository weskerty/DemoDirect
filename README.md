...
Énfasis, también conocido como cursiva, con asteriscos o guiones bajos.

Énfasis fuerte, también conocido como negrita, con *asteriscos* o _guiones bajos_.

Énfasis combinado con *asteriscos y guiones bajos*.
...
## Imágenes
Para agregar imagenes simples (sin galeria tipo carrusel) es:
...
Asi se vera (pasa el mouse para ver el texto del título):
