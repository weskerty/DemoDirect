# Democracia Directa
Este Repositorio/Web es un manifiesto de un nuevo sistema politico basado en democracia directa
Tambien incluye una lista de Corrupcion colaborativa Anonima.
...
## Uso de Estilos de Texto (MarkDown)
El estilo es Similar a WhatsApp, Telegram, Discord o cualquiera que tambien use MarkDown

Esta guía está pensada como referencia rápida y demostración. Para información más completa, consulta [la especificación original de John Gruber](http://daringfireball.net/projects/markdown/) y la [página de información de Github-flavored Markdown](http://github.github.com/github-flavored-markdown/).

Ten en cuenta que también hay una [Guía específica para Markdown Here](./Markdown-Here-Cheatsheet) si eso es lo que estás buscando. También puedes revisar [más herramientas de Markdown](./Other-Markdown-Tools).
